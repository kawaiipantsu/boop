...
var commandSpecs = []commandSpec{
	...
	{Name: "config", Args: "[mode|agents|web|log|save]", Summary: "show or adjust effective configuration (§55)", Status: cmdReady},
	...
	{Name: "review", Args: "[path]", Summary: "review code changes against reviewer guidelines (§29)", Status: cmdReady},
