...
var commandSpecs = []commandSpec{
	...
	{Name: "config", Args: "[edit | <field> <value>]", Summary: "show the configuration, open the full-screen editor (/config edit), or set one field; credentials are never printed", Status: cmdReady},
